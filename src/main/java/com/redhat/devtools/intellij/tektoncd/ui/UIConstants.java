...
public class UIConstants {
    ...
    public static final Color LIGHT_GREY_204 = new Color(204, 204, 204);
    ...
    public static final Font TIMES_PLAIN_10 = new Font("TimesRoman", Font.PLAIN, 10);
    public static final Font TIMES_PLAIN_14 = new Font("TimesRoman", Font.PLAIN, 14);
